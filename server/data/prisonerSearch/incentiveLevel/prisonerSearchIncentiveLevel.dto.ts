...
export interface PrisonerSearchIncentiveLevelDto {
  level: {
    code: string // code has been left as type string rather than an enum of the incentive level consts above because new levels can be added by individual prisons
    description: string
  }
  dateTime: string

  ...
  describe('when the user has the required role', () => {
    ...
    it('should show upcoming categorisations', () => {
      ...
      categoriserHomePage.validateToDoTableData([
        ...
        ['Overdue', 'Hillmob, AntB0040AA', '70', 'Started (Api User)', '', 'Edit'],
        ['Overdue', 'Missing, AwaitingB0031AA', '55', 'Awaiting approval', 'Engelbert Humperdinck', 'PNOMIS'],
        ['Overdue', 'Started, AwaitingB0032AA', '50', 'Started (Api User)', 'Engelbert Humperdinck', 'PNOMIS'],
        ['Overdue', 'Awaiting, AwaitingB0033AA', '47', 'Awaiting approval', 'Engelbert Humperdinck', 'View'],
        ['Overdue', 'Approved, AwaitingB0034AA', '43', 'Approved', 'Engelbert Humperdinck', 'PNOMIS'],
        ['Overdue', 'Missing, UncategorisedB0035AA', '39', 'Not categorised', 'Engelbert Humperdinck', 'Start'],
        ['Overdue', 'Started, UncategorisedB0036AA', '19', 'Started (Api User)', 'Engelbert Humperdinck', 'Edit'],
        [
